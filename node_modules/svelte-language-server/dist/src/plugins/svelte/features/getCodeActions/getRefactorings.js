...
async function executeExtractComponentCommand(svelteDoc, refactorArgs) {
    ...
    return {
        documentChanges: [
            vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.VersionedTextDocumentIdentifier.create(svelteDoc.uri, 0), [
    ...
    function createNewFileEdit() {
        ...
        const newText = [
            ...
            .map((tag) => tag.text)
            .join('');
        return vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.VersionedTextDocumentIdentifier.create(newFileUri, 0), [
