import { Position, SignatureHelpContext, SignatureHelp } from 'vscode-languageserver';
...
export declare class SignatureHelpProviderImpl implements SignatureHelpProvider {
    ...
    getSignatureHelp(document: Document, position: Position, context: SignatureHelpContext | undefined): Promise<SignatureHelp | null>;
    private isReTrigger;
